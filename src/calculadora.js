...
function Calculadora() {
  ...
  //desmembramento de retorno na variavel de estado
  //define dois elementos para o retorno do metodo useState
  //quando chamamos useState com parametro estamos definindo um valor padrao useState('0')
  ...
  function definirOperacao( op ) {
    ...
    //caso opercao estiver definida e numero 2 selecionado realia o calculo da operacao
    if( numero2 !== null) {
  ...
  return (
    //recebe um obj json
    <Jumbotron style={{background: 'transparent!important', backgroundColor: '#007bff', padding: '5px',    margin: '5px', width: '400px'
